...
Juels and Kaliski~\cite{JK07} and Naor and Rothblum~\cite{NR09} considered formal models for POS systems (in the context of authenticators and proofs of retrievability, respectively).
Subsequently, a series of improvements have been proposed, see for example~\cite{}.

Ateniese et al.~\cite{ABC+11} considered the first POS system with public verifiability in what they called provable data possession (PDP).
In comparison to PORs, PDP does not guarantee retrievability of the stored file.

POS systems supporting dynamic data update~\cite{}

Application to mining of bitcoin~\cite{}
