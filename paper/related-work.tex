...
Subsequently, a series of improvements have been proposed, for example, in terms of public verifiability~\cite{AKK09,ABC+11}, compactness of proofs~\cite{SW13}, support for dynamic data update~\cite{SDJ+12,CKW13,SSP13}, and security against a stronger adversarial model~\cite{BJO09a}.
...
Our PDF scheme bears some similarity with HAIL~\cite{BJO09b}, another distributed POR system, in the sense that files are divided in segments and stored across multiple entities.
